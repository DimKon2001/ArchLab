...
* Cost = (20*size(l1) + size(l2))*c + (associativity(l1i)  + associativity(l1d) + associativity(l2) )*d
...
Ένας τύπος που προτείνουμε τελικά για το συνολικό κόστος, προσθέτοντας τους δύο όρους είναι (size σε kB):

total_cost = (20 * (size(l1d) + size(l1i)) + size(l2)) * c1 / Cost_fastest_implementation + exec_time * c2 / execution_time_fastest_implementation

Θεωρώντας πως σε κάποιες εφαρμογές μας ενδιαφέρει το μικρότερο δυνατό κόστος, ενώ σε άλλες ο μικρότερος δυνατός χρόνος επιλέγονται κατάλληλα οι παράγοντες c1 και c2. Στα πλαίσια της βελτιστοποίησης που έχει ήδη παρουσιαστεί, τα χαρακτηριστικά του επεξεργαστή διαλέχθηκαν με τέτοιο τρόπο, ώστε να υπάρχει ο πιο μικρός χρόνος εκτέλεσης με αποδεκτό σχετικά κόστος, δηλαδή το σύστημα είναι τέτοιο ώστε να πλησιάζει το ιδανικό CPI, χωρίς όμως να αυξάνεται αρκετά το Cost.


### Κριτική Εργαστηρίου

Σε αυτό το εργαστηρμας δημιούργησε πρόβλημα το μεγάλος πλήθος προσομοιώσεων που απαιτούνταν για τους διάφορους συνδυασμούς παραγόντων της μνήμης, καθώς έκαναν οδήγησε σε μεγάλο χρόνο προσομοιώσεων και σε αρκετά δύσκολες θεωρήσεις για την εύρεση της καλύτερης αρχιτεκτονικής. Ακόμη η αδυναμία εύρεσης του κόστους μιας cache στο διαδίκτυο (με καλή ακρίβεια), μας ανάγκασε να υιοθετήσουμε αυθαίρετες τιμές ως προς το κόστος των διάφορων επιπέδων μνήμης, ενώ στην συνάρτηση δεν καταφέραμε να βρούμε τιμές για τους παράγοντες c1 και c2, καθώς δεν ξέραμε την σημαντικότητα του κόστους ή του execution time για κάθε εφαρμογή. Έτσι αυτό που καταλάβαμε είναι ότι είναι αδύνατο να φτιάξει κάποιος την ιδανική αρχιτεκτονική για general purpose επεξεργαστές, καθώς κάθε χρήστης έχει άλλη απαίτηση για την σχέση execution time και κόστους, οπότε πρέπει να γίνουν κάποιοι συμβιβασμοί. Τέλος, η εργασία αυτή είχε πολύ μεγαλύτερη δυσκολία σε σχέση με την πρώτη και ίσως να βοηθούσε κάποιο επιπλέον υλικό για την συνάρτηση κόστους.
