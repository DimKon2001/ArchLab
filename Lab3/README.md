...
* 
    O mcpat βγάζει αποτελέσματα τα οποία σχετίζονται με την ισχύ των διάφορων components ενός επεξεργαστή και όχι με την κατανάλωση ενέργειας κατά την εκτέλεση ενός workload.
    Συνεπώς η διάρκεια της μπαταρίας δεν εξαρτάται μόνο από την ισχύ που βγάζει ο mcpat, αλλά και από την ώρα που διήρκησε το workload.
