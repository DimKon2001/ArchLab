 ...
 * Για τον **Xeon** ισχύει:
  ...
  Eπομένως:
  $$\frac{Energy_{Αrm}(Wh)}{{Energy_{Xeon}(Wh)}}   = \frac{50}{1} * \frac{3.069217 W *TimeDuration(h)}{109.7518 W * TimeDuration(h)} = \frac{10}{12} > 1$$
  ...
  $$TotalLeakage_{Αrm} = 0.108687 W <<  TotalLeakage_{Xeon} = 36.8319 W$$
...
Τέλος, η ανάλυση μας μπορεί να περιέχει λάθη, γιατί θεωρούμε πως ο κάθε παράγοντας που επηρεάζει το EDP είναι ανεξάρτητος από τους άλλους, δηλαδή πως ο συνδυασμός δύο <<καλών>> επιλογών θα οδηγήσει σε ακόμη καλύτερη υλοποίηση, το οποίο δεν ισχύει πάντα. Aκόμη δεν περιμένουμε να έχουμε τα καλύτερα δυνατά αποτελέσματα, γιατί ο [mcpat προσομοιώνει μοντέλα τα οποία ή είναι ημιτελή ή  πολύ high level ή έχουν υλοποιήσεις που διαφέρουν από αυτές του πυρήνα.](https://www.samxi.org/papers/xi_hpca2015.pdf). Ακόμη κατά την μετατροπή του αρχείου του gem5 στο xml του mcpat κάποιοι παράγοντες ήταν NaN οπότε γίνονταν αυθαίρετα μηδέν, γεγονός που μπορεί να οδηγήσει σε λάθη.


### Κριτική Εργαστηρίου
Η κύρια δυσκολία σε αυτό το εργαστήριο ήταν η έλλειψη οικειότητας με το πρόγραμμα mcpat. Για το υπόλοιπο τεχνικό κομμάτι δεν συναντήσαμε κάποια ιδιαίτερη δυσκολία καθώς χρησιμοποιήσαμε βοηθητικά scripts για την επιτάχυνση της διαδικασίας. Επίσης, το γεγονός ότι χρησιμοποιήσαμε τα αποτελέσματα του προηγούμενου εργαστηρίου για το gem5, μας έδωσε περισσότερο χρόνο να εμβαθύνουμε στα ερωτήματα του εργαστηρίου αυτού.  
