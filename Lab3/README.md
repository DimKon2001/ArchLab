...
**1.** Χρησιμοποιώντας το **_mcpat_**, υπολογίσαμε διάφορα χαρακτηριστικά για τις αρχιτεκτονικές που προέκυψαν από τις αλλαγές στις cache του προηγούμενου εργαστηρίου. Για τον σκοπό αυτό, έγινε χρήση των παρεχόμενων python script: Αρχικά του [GEM5toMCPAT.py]() για την μετατροπή της εξόδου του GEM5 σε κατάλληλη είσοδο για το mcpat και στη συνέχεια του [print_energy.py]() για τον υπολογισμό της ενέργειας από τα αποτελέσματα του gem5.