...
Η ανάλυση μας έχει λάθη, γιατί θεωρούμε πως ο κάθε παράγοντας που επηρεάζει το EDP είναι ανεξάρτητος από τους άλλους, δηλαδή πως ο συνδυασμός δύο <<καλών>> επιλογών θα οδηγήσει σε ακόμη καλύτερη υλοποίηση, το οποίο δεν ισχύει πάντα. Aκόμη δεν περιμένουμε να έχουμε τα καλύτερα δυνατά αποτελέσματα, γιατί ο gem5 προσομοιώνει πχ 
