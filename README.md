...
3. 1. Για το πρόγραμμα πρόσθεσης πινάκων, η TimingSimple CPU είχε sim_secs 0.000489 ενώ η Minor CPU 0.000289. 
   2. H TimingSimple CPU ήταν πιο αργή σαν gem5 πρόγραμμα, καθώς η simulated CPU δεν έχει pipeline και για αυτό κάνει stall σε κάθε memory access (στους πίνακες υπάρχουν εκατοντάδες memory accesses) περιμένοντας το αποτέλεσμα, ενώ για τον ίδιο λόγο απαιτείται η προσομοίωση λιγότερων παραγόντων, άρα η προσομοίωση είχε μικρότερη χρονική διάρκεια.  
